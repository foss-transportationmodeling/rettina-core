...
import numpy as np
import pandas as pd
from mapmatching import MM_main
from dateutil.parser import parse
import pytz
import datetime
import fiona
from mapmatching.gps_point_cand_point.GPS_point import lat_long_to_UTM_point
...
class Validate(object):
    ...
    def plot_roadnetwork(self, ax, fig, select=False, color='k',
            road_shp_file = os.path.join('../../data/Relevant_files',
